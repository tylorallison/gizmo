...
class XForm extends GizmoData {
    ...
    static {
        ...
        this.schema(this, 'bounds', { autogen: true, generator: (o, v) => o.computeBounds(), atUpdate: (r,o,k,ov,nv) => {
            //let gzo = o.$trunk;
            //console.log(`xform bounds updated r: ${r}[${r.$link.trunk}], o: ${o}[${o.$link.trunk}] ov: ${ov} nv: ${nv}`);
    ...
    computeBounds() {
        ...
        console.log(`computeBounds: ${minx},${miny} ${width},${height}`);
