...
class MoveAction extends Action {
    ...
    static {
        this.schema(this, 'speed', { dflt: 0 });
        this.schema(this, 'targetSpeed', { parser: (o,x) => x.hasOwnProperty('targetSpeed') ? x.targetSpeed : o.speed });
        this.schema(this, 'accel', { dflt: 0 });
        this.schema(this, 'heading', { dflt: 0 });
        this.schema(this, 'overx', { dflt: 0, eventable: false });
        this.schema(this, 'overy', { dflt: 0, eventable: false });
        // -- autogenerated dx/dy, regenerated upon heading changes
        this.schema(this, 'dx', { eventable: false, autogen: (k) => k === 'heading', generator: (o, x) => Math.cos(o.heading) });
        this.schema(this, 'dy', { eventable: false, autogen: (k) => k === 'heading', generator: (o, x) => Math.sin(o.heading) });
    }
...
class MoveToAction extends MoveAction {
    static {
        ...
        this.schema(this, 'snap', { dflt: false });
        this.schema(this, 'range', { parser: (o,x) => x.hasOwnProperty('range') ? x.range : o.constructor.dfltRange });
        this.schema(this, 'chained', { dflt: false });
        // facing?
    }
...
class MoveSystem extends System {
    ...
    static {
        this.schema(this, 'actorLocator', { eventable: false, dflt: (actor) => (actor) ? new Vect({x:actor.xform.x, y:actor.xform.y}) : Vect.zero });
        this.schema(this, 'targetLocator', { eventable: false, dflt: (target) => target });
        this.schema(this, 'actorMover', { eventable: false, dflt: (actor, loc) => { if (actor && loc) { actor.xform.x = loc.x; actor.xform.y = loc.y }}} );
        this.schema(this, 'minDelta', { eventable: false, dflt: .001 });
        this.schema(this, 'minSpeed', { eventable: false, dflt: .001 });
    }
