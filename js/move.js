...
class MoveAction extends Action {
    ...
    static {
        ...
        Schema.apply(this, 'dx', { eventable: false, autogen: (k) => k === 'heading', generator: (o, x) => Math.cos(o.heading) });
        Schema.apply(this, 'dy', { eventable: false, autogen: (k) => k === 'heading', generator: (o, x) => Math.sin(o.heading) });
    }
